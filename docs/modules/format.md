...
A key feature of this module is the alignment of disparate datasets (RME, CMIP6) with a "canonical" spatial geopackage, ensuring that location IDs and ordering remain consistent across all data layers.
